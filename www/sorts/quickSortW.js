// generated by VivioJS 22.02 build 0 : 14-Feb-22 14:28:09

"use strict"

function quickSortW(vplayer) {
	...
	function colour(i, pivotIndx) {
		$g[54][i].setPen(i==pivotIndx ? $g[7] : ($g[53][i]>=$g[53][pivotIndx] ? $g[5] : $g[4]))
		$g[54][i].setBrush(i==pivotIndx ? $g[22] : ($g[53][i]>=$g[53][pivotIndx] ? $g[20] : $g[19]))
	}

	function colourPartition(L, R, pivotIndx) {
		for (let i=L; i<=R; i++)
		colour(i, pivotIndx)
	}

	function colourSorted(i) {
		$g[54][i].setPen($g[3])
	...
	function $execute(thread) {
		...
		while (1) {
			...
			case 21:
				...
				$pc = 22
			case 22:
				$g[55]=new Rectangle2($g[0], 0, HCENTRE, 0, $g[35], 5, 5, W/2, TITLEY, $g[2], $g[40], "Quicksort (Wirth)")
				$g[55].setRounded(5, 5)
				$g[55].setTxtOff(0, 2)
			...
			case 24:
				...
				continue
			case 25:
				$g[57]=new SolidPen(0, 7, rgba(0, 0.40000000000000002, 0), ARROW60_START)
				$g[58]=new Line2($g[0], 0, 0, $g[57], $g[56]+SZ/2, Y+SZ, 0, 40)
				$g[58].setOpacity(0)
				$g[59]=new SolidPen(0, 7, BLUE, ARROW60_START)
				$g[60]=new Line2($g[0], 0, 0, $g[59], $g[56]+(N-2)*SZ+GAP+SZ/2, Y+SZ, 0, 40)
				$g[60].setOpacity(0)
				$g[61]=new Rectangle2($g[0], 0, 0, 0, 0, 0, 0, SZ, 14, $g[7], $g[36], "pivot")
				$g[61].setOpacity(0)
				$g[62]=0
				$g[63]=new Txt($g[0], 0, HLEFT|VTOP, BORDER, H-140, $g[5], $g[38], "comparisons: 0")
				$g[64]=0
				$g[65]=new Txt($g[0], 0, HLEFT|VTOP, BORDER, H-120, $g[5], $g[38], "exchanges: 0")
				$g[66]=new Txt($g[0], 0, HLEFT|VTOP, BORDER, H-SZ, $g[1], $g[39], "CLICK \"start\" to sort list into ascending order")
				$pc = 26
				if (wait(1)) {
					return
				}
			...
			case 27:
				...
				continue
			case 28:
				$g[66].setTxt("List now in ascending order")
			...
			case 39:
				$enter(0);	// flash
				$g[54][$stack[$fp-3]].toggleBrushAndPens($g[30], $g[54][$stack[$fp-3]].getPen(), $g[54][$stack[$fp-3]].getTxtPen(), 5, getTPS()/4, 0)
				$pc = 40
				if ($g[54][$stack[$fp-4]].toggleBrushAndPens($g[30], $g[54][$stack[$fp-4]].getPen(), $g[54][$stack[$fp-4]].getTxtPen(), 5, getTPS()/4, 1)) {
					return
				}
			case 40:
				$return(2)
				continue
			case 41:
				$enter(2);	// trackExchange
				if (!($stack[$fp-3]==$stack[$fp-5])) {
					$pc = 42
					continue
				}
				$g[61].translate(0, -80, TICKS, 0)
				$pc = 42
			case 42:
				$g[54][$stack[$fp-3]].translate(0, -80, TICKS, 0)
				if (!($stack[$fp-4]==$stack[$fp-5])) {
					$pc = 43
					continue
				}
				$g[61].translate(0, -100, TICKS, 0)
				$pc = 43
			case 43:
				$pc = 44
				if ($g[54][$stack[$fp-4]].translate(0, -100, TICKS, 1)) {
					return
				}
			case 44:
				$stack[$fp+1]=($stack[$fp-4]-$stack[$fp-3])*(SZ+GAP)
				$stack[$fp+2]=($stack[$fp-4]-$stack[$fp-3])*10
				if (!($stack[$fp-3]==$stack[$fp-5])) {
					$pc = 45
					continue
				}
				$g[61].translate($stack[$fp+1], 0, $stack[$fp+2], 0)
				$pc = 45
			case 45:
				$g[54][$stack[$fp-3]].translate($stack[$fp+1], 0, $stack[$fp+2], 0)
				if (!($stack[$fp-4]==$stack[$fp-5])) {
					$pc = 46
					continue
				}
			...
			case 46:
				$pc = 47
				if ($g[54][$stack[$fp-4]].translate(-$stack[$fp+1], 0, $stack[$fp+2], 1)) {
					return
				}
			case 47:
				if (!($stack[$fp-3]==$stack[$fp-5])) {
			...
			case 50:
				...
				$g[54][$stack[$fp-4]].setPos($g[56]+$stack[$fp-4]*(SZ+GAP)+SZ/2, Y)
				$return(3)
				continue
			case 51:
				$enter(0);	// compare
			...
			case 52:
				$g[62]++
				$g[63].setTxt("comparisons: %d", $g[62])
				$return(2)
				continue
			case 53:
				$enter(1);	// exchange
				...
				$call(41, $obj, $stack[$fp-3], $stack[$fp-4], $stack[$fp-5])
				continue
			case 54:
				$g[64]++
				$g[65].setTxt("exchanges: %d", $g[64])
				$return(3)
				continue
			case 55:
				$enter(0);	// setPointerOpacity
			...
			case 58:
				...
				$stack[$fp+3]=(($stack[$fp-3]+$stack[$fp-4])/2)|0
				$stack[$fp+4]=$g[53][$stack[$fp+3]]
				$stack[$fp+5]=((SZ+GAP)-SZ)/2-$stack[$fp-5]*3
				$stack[$fp+6]=new Rectangle2($g[0], 0, 0, $g[33], 0, $g[56]+$stack[$fp-3]*(SZ+GAP)-$stack[$fp+5], Y-SZ/2-$stack[$fp+5], ($stack[$fp-4]-$stack[$fp-3])*(SZ+GAP)+SZ+2*$stack[$fp+5], SZ+2*$stack[$fp+5])
				colourPartition($stack[$fp-3], $stack[$fp-4], $stack[$fp+3])
				$g[66].setTxt("Select pivot - choose element in \"middle\" of array being partitioned)")
				$g[61].setPos($g[56]+$stack[$fp+3]*(SZ+GAP), Y-SZ-GAP)
				$g[61].setOpacity(1)
				$g[58].setPos($g[56]+$stack[$fp+1]*(SZ+GAP)+SZ/2, Y+SZ)
				$g[60].setPos($g[56]+$stack[$fp+2]*(SZ+GAP)+SZ/2, Y+SZ+30)
				$call(55, $obj, 1)
				continue
			case 59:
				$pc = 60
			...
			case 60:
				$pc = 61
			case 61:
				$g[66].setTxt("Partition: search forward for element >= pivot")
				$pc = 62
			case 62:
				if (!(1)) {
					$pc = 66
				...
				$call(51, $obj, $stack[$fp+1], $stack[$fp+3])
				continue
			case 63:
				if (!($g[53][$stack[$fp+1]]>=$stack[$fp+4])) {
					$pc = 64
					continue
				}
				$pc = 66
			...
			case 64:
				$pc = 65
				if ($g[58].translate(SZ+GAP, 0, TICKS, 1)) {
					return
				}
			case 65:
				$stack[$fp+1]++
				...
				continue
			case 66:
				$g[66].setTxt("Partition: search backwards for element < pivot")
				$pc = 67
			case 67:
				if (!(1)) {
					$pc = 71
				...
				$call(51, $obj, $stack[$fp+3], $stack[$fp+2])
				continue
			case 68:
				if (!($stack[$fp+4]>=$g[53][$stack[$fp+2]])) {
					$pc = 69
					continue
				}
				$pc = 71
			...
			case 69:
				$pc = 70
				if ($g[60].translate(-(SZ+GAP), 0, TICKS, 1)) {
					return
				}
			case 70:
				$stack[$fp+2]--
			...
			case 71:
				...
				$g[66].setTxt("Partition: swap elements")
				$call(53, $obj, $stack[$fp+1], $stack[$fp+2], $stack[$fp+3])
				continue
			case 72:
				$stack[$fp+3]=$stack[$fp+3]==$stack[$fp+1] ? $stack[$fp+2] : $stack[$fp+3]==$stack[$fp+2] ? $stack[$fp+1] : $stack[$fp+3]
				colourPartition($stack[$fp+1], $stack[$fp+2], $stack[$fp+3])
				$stack[$fp+1]++
				$stack[$fp+2]--
				$g[58].translate(SZ+GAP, 0, 10, 0)
				$pc = 73
				if ($g[60].translate(-SZ-GAP, 0, 10, 1)) {
					return
				}
			case 73:
				$pc = 74
			...
			case 75:
				$g[61].setOpacity(0)
				colourSorted($stack[$fp+3])
				if (!($stack[$fp-3]<$stack[$fp+2])) {
					$pc = 77
					continue
				}
				$call(57, $obj, $stack[$fp-3], $stack[$fp+2], $stack[$fp-5]+1)
				continue
			case 76:
				$pc = 78
				continue
			...
			case 78:
				...
				$call(57, $obj, $stack[$fp+1], $stack[$fp-4], $stack[$fp-5]+1)
				continue
			case 79:
				$pc = 81
				continue
			case 80:
				colourSorted($stack[$fp-4])
				$pc = 81
			case 81:
				$return(3)
				continue
