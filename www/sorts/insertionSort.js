// generated by VivioJS 22.02 build 0 : 14-Feb-22 14:28:04

"use strict"

function insertionSort(vplayer) {
	...
	function $execute(thread) {
		...
		while (1) {
			...
			case 21:
				...
				$g[55]=new SolidPen(0, 6, BLACK, ARROW60_START)
				$g[56]=new SolidPen(0, 6, rgba(0, 0.40000000000000002, 0), ARROW60_START)
				$g[57]=new Rectangle2($g[0], 0, HCENTRE, 0, $g[35], 10, 5, W/2, 48, $g[2], $g[40], "Insertion Sort")
				$g[57].setRounded(5, 5)
				$g[57].setTxtOff(0, 2)
				$g[57].setPt(1, $g[57].getTxtW()+16, 48)
				$g[58]=(W-N*(SZ+GAP)-GAP)/2
				$g[52]=0
				$pc = 22
			case 22:
				if (!($g[52]<N)) {
				...
				$g[54][$g[52]]=new Ellipse2($g[0], 0, 0, $g[3], $g[18], $g[58]+$g[52]*(SZ+GAP), Y, SZ, SZ, $g[1], $g[39], "%d", $g[53][$g[52]])
				$pc = 23
			case 23:
				$g[52]++
				$pc = 22
				continue
			case 24:
				$g[59]=new Line($g[0], 0, ABSOLUTE, $g[33], 0, 0, $g[58]+SZ+GAP/2, Y-150, $g[58]+SZ+GAP/2, Y+2*SZ)
				$g[60]=new Txt($g[0], 0, HCENTRE|VTOP, $g[58]+SZ/2, Y-160, $g[1], $g[36], "sorted")
				$g[61]=new Line($g[0], 0, 0, $g[55], $g[58]+SZ/2, Y-130, -20, 0, 40, 0)
				$g[62]=new Line2($g[0], 0, 0, $g[56], $g[58]+SZ/2, Y+SZ+GAP, 0, 40)
				$g[63]=0
				$g[64]=new Txt($g[0], 0, HLEFT|VTOP, 10, H-140, $g[5], $g[38], "comparisons: 0")
				$g[65]=0
				$g[66]=new Txt($g[0], 0, HLEFT|VTOP, 10, H-120, $g[5], $g[38], "exchanges: 0")
				$g[67]=new Txt($g[0], 0, HLEFT|VTOP, 10, H-35, $g[1], $g[39], "CLICK \"start\" to sort list into ascending order")
				$pc = 25
				if (wait(1)) {
					return
				}
			...
			case 27:
				...
				continue
			case 28:
				$g[67].setTxt("List now in ascending order")
			...
			case 39:
				$enter(2);	// trackInsert
				$pc = 40
				if ($g[54][$stack[$fp-4]].translate(0, -100, 20, 1)) {
					return
				}
			case 40:
				$stack[$fp+1]=$stack[$fp-4]-$stack[$fp-3]
			...
			case 41:
				...
				$g[54][$stack[$fp+2]].translate(SZ+GAP, 0, $stack[$fp+1]*10, 0)
				$pc = 42
			case 42:
				$stack[$fp+2]++
				$pc = 41
			...
			case 43:
				$pc = 44
				if ($g[54][$stack[$fp-4]].translate(-$stack[$fp+1]*(SZ+GAP), 0, $stack[$fp+1]*10, 1)) {
					return
				}
			case 44:
				$pc = 45
			...
			case 46:
				...
				$g[54][$stack[$fp+2]].setPos($g[58]+$stack[$fp+2]*(SZ+GAP), Y)
				$g[54][$stack[$fp+2]].setTxt("%d", $g[53][$stack[$fp+2]])
				$pc = 47
			case 47:
				$stack[$fp+2]++
				$pc = 46
			...
			case 49:
				...
				$pc = 50
				if ($g[54][$stack[$fp-4]].toggleBrushAndPens($g[21], $g[54][$stack[$fp-4]].getPen(), $g[54][$stack[$fp-4]].getTxtPen(), 5, getTPS()/4, 1)) {
					return
				}
			case 50:
				$g[63]++
				$g[64].setTxt("comparisons: %d", $g[63])
				$return(2)
				continue
			case 51:
				$enter(2);	// insert
				$pc = 52
				if ($g[62].setOpacity(0, 20, 1)) {
					return
				}
			case 52:
				...
				$stack[$fp+1]=$g[53][$stack[$fp-4]]
				$stack[$fp+2]=$stack[$fp-4]
				$pc = 53
			case 53:
				if (!($stack[$fp+2]>$stack[$fp-3])) {
					$pc = 55
					continue
				}
				$g[53][$stack[$fp+2]]=$g[53][$stack[$fp+2]-1]
				$pc = 54
			case 54:
				$stack[$fp+2]--
				$pc = 53
				continue
			case 55:
				$g[53][$stack[$fp-3]]=$stack[$fp+1]
				$call(39, $obj, $stack[$fp-3], $stack[$fp-4])
				continue
			case 56:
				$g[65]+=$stack[$fp-4]-$stack[$fp-3]
				$g[66].setTxt("exchanges: %d", $g[65])
				$pc = 57
			case 57:
			...
			case 58:
				$enter(0);	// showg
				$g[59].setOpacity($stack[$fp-3], 20, 0)
				$g[60].setOpacity($stack[$fp-3], 20, 0)
				$pc = 59
				if ($g[61].setOpacity($stack[$fp-3], 20, 1)) {
					return
				}
			case 59:
				$return(1)
			...
			case 60:
				$enter(0);	// translateg
				$g[59].translate(SZ+GAP, 0, 20, 0)
				$g[60].translate(SZ+GAP, 0, 20, 0)
				$pc = 61
				if ($g[61].translate(SZ+GAP, 0, 20, 1)) {
					return
				}
			case 61:
				$return(0)
			...
			case 63:
				...
				$g[62].setPos($g[58]+SZ/2, Y+SZ+GAP)
				$pc = 64
				if ($g[62].setOpacity(1, 20, 1)) {
					return
				}
			case 64:
				$g[54][$stack[$fp+1]].setBrush($g[19])
				$g[67].setTxt("Find position to insert %d", $g[53][$stack[$fp+1]])
				$stack[$fp+2]=0
				$pc = 65
			case 65:
				...
				continue
			case 66:
				if (!(($g[53][$stack[$fp+1]]>$g[53][$stack[$fp+2]])==0)) {
					$pc = 67
					continue
				}
				$pc = 70
			...
			case 67:
				$pc = 68
				if ($g[62].translate(SZ+GAP, 0, 20, 1)) {
					return
				}
			case 68:
				$pc = 69
			case 69:
				...
				continue
			case 70:
				$g[67].setTxt("Insert %d at correct position", $g[53][$stack[$fp+1]])
				$call(51, $obj, $stack[$fp+2], $stack[$fp+1])
				continue
			case 71:
				$call(60, $obj)
				continue
