// generated by VivioJS 22.02 build 0 : 14-Feb-22 14:28:00

"use strict"

function exchangeSort(vplayer) {
	...
	function Limit($grp, x, y) {
		Group.call(this, $grp, 0, ((0) | EXTENDEDGOBJ), x, y)
		new Line2(this, 0, ABSOLUTE, $g[33], 0, 0, 0, 270)
		this.$leftArrowPen=new SolidPen(0, 7, BLACK, ARROW60_START)
		new Line2(this, 0, 0, this.$leftArrowPen, -55, 250, 45, 0)
		this.$rightArrowPen=new SolidPen(0, 7, BLACK, ARROW60_END)
		new Line2(this, 0, 0, this.$rightArrowPen, 10, 5, 60, 0)
		new Txt(this, 0, HRIGHT|VTOP, -10, 220, $g[1], $g[36], "sorted")
		new Txt(this, 0, HLEFT|VTOP, 10, 15, $g[1], $g[36], "unsorted")
	}
	...
	function $execute(thread) {
		...
		while (1) {
			...
			case 21:
				...
				$g[55]=new Rectangle2($g[0], 0, HCENTRE, 0, $g[35], BORDER, TITLEY, W/2, TITLEH, $g[2], $g[40], "Exchange Sort")
				$g[55].setRounded(5, 5)
				$g[55].setTxtOff(0, 2)
			...
			case 23:
				...
				continue
			case 24:
				$g[57]=new Limit($g[0], $g[56]-GAP/2, Y-130)
				$g[57].setOpacity(0)
				$g[58]=new SolidPen(0, 6, rgba(0, 0.40000000000000002, 0), ARROW60_START)
				$g[59]=new Line2($g[0], 0, 0, $g[58], $g[56]+SZ/2, Y+2*SZ, 0, 40)
				$g[59].setOpacity(0)
				$g[60]=new Rectangle2($g[0], 0, 0, 0, $g[21], $g[56], Y+SZ+10, SZ, 20, $g[1], $g[36], "min")
				$g[60].setRounded(4, 4)
				$g[60].setOpacity(0)
				$g[62]=0
			...
			case 39:
				$enter(0);	// flash
				$pc = 40
				if ($g[59].translate(SZ+GAP, 0, TICKS, 1)) {
					return
				}
			case 40:
				$g[54][$stack[$fp-3]].setBrush($g[21])
				$g[54][$stack[$fp-3]].toggleBrushAndPens($g[18], $g[3], $g[54][$stack[$fp-3]].getTxtPen(), 5, getTPS()/4, 0)
				$pc = 41
				if ($g[54][$stack[$fp-4]].toggleBrushAndPens($g[18], $g[3], $g[54][$stack[$fp-4]].getTxtPen(), 5, getTPS()/4, 1)) {
					return
				}
			case 41:
			...
			case 43:
				...
				$call(39, $obj, $stack[$fp+2], $g[61])
				continue
			case 44:
				$g[62]++
				$g[63].setTxt("comparisons: %d", $g[62])
				if (!($g[53][$stack[$fp+2]]<$stack[$fp+1])) {
					$pc = 46
					continue
				}
				$stack[$fp+1]=$g[53][$stack[$fp+2]]
				$g[54][$g[61]].setBrush($g[18])
				$g[61]=$stack[$fp+2]
				$pc = 45
				if ($g[60].setPos($g[56]+$g[61]*(SZ+GAP), Y+SZ+10, TICKS, 1)) {
					return
				}
			case 45:
				$pc = 46
			case 46:
				$g[54][$g[61]].setBrush($g[21])
				$pc = 47
			case 47:
				$stack[$fp+2]++
				$pc = 43
			...
			case 53:
				...
				$g[60].setOpacity($stack[$fp-3], TICKS, 0)
				$pc = 54
			...
			case 56:
				...
				$g[59].setPos($g[56]+SZ/2+$stack[$fp+1]*(SZ+GAP), Y+2*SZ)
				$g[60].setPos($g[56]+$stack[$fp+1]*(SZ+GAP), Y+SZ+10)
				$call(53, $obj, 1)
				continue
			case 57:
				$g[54][$stack[$fp+1]].setBrush($g[21])
				$g[66].setTxt("Find minimum element in unsorted part of list")
				$pc = 58
				if (wait(TICKS)) {
					return
				}
			...
			case 59:
				$stack[$fp+2]=$g[61]
				$g[54][$stack[$fp+2]].setBrush($g[21])
				$g[59].setOpacity(0)
				$g[60].setOpacity(0)
				$stack[$fp+3]=$g[53][$stack[$fp+2]]
				$g[53][$stack[$fp+2]]=$g[53][$stack[$fp+1]]
				$g[53][$stack[$fp+1]]=$stack[$fp+3]
				if (!($stack[$fp+2]!=$stack[$fp+1])) {
					$pc = 61
					continue
				}
				$g[64]++
				$g[65].setTxt("exchanges: %d", $g[64])
				$g[66].setTxt("Swapping first and minimum elements")
				$call(49, $obj, $stack[$fp+1], $stack[$fp+2])
				continue
			case 60:
				$pc = 63
				continue
			...
			case 62:
				$pc = 63
			case 63:
				$g[54][$stack[$fp+2]].setBrush($g[18])
				$g[66].setTxt("Reduce unsorted part of list")
				$g[57].translate(SZ+GAP, 0, TICKS, 0)
				checkPoint()
				$pc = 64
			case 64:
				$stack[$fp+1]++
