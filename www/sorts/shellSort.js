// generated by VivioJS 22.02 build 0 : 14-Feb-22 14:28:13

"use strict"

function shellSort(vplayer) {
	...
	function $execute(thread) {
		...
		while (1) {
			...
			case 21:
				...
				$g[44].addEventHandler("eventMB", $obj, 28)
				$g[46].addEventHandler("eventMB", $obj, 30)
				$g[47].addEventHandler("eventMB", $obj, 32)
				$g[48].addEventHandler("eventMB", $obj, 34)
				$g[49].addEventHandler("eventMB", $obj, 36)
				...
				$pc = 22
			case 22:
				$g[55]=new Rectangle2($g[0], 0, HCENTRE, 0, $g[35], BORDER, TITLEY, W/2, TITLEH, $g[2], $g[40], "Shell Sort")
				$g[55].setRounded(5, 5)
				$g[55].setTxtOff(0, 2)
			...
			case 25:
				...
				$g[58].setOpacity(0)
				$g[59]=0
				$g[60]=new Txt($g[0], 0, HLEFT|VTOP, BORDER, H-140, $g[5], $g[38], "comparisons: 0")
				$g[61]=0
				$g[62]=new Txt($g[0], 0, HLEFT|VTOP, BORDER, H-120, $g[5], $g[38], "exchanges: 0")
				$g[63]=new Txt($g[0], 0, HLEFT|VTOP, BORDER, H-SZ, $g[1], $g[39], "CLICK \"start\" to sort list into ascending order")
				$pc = 26
				if (wait(1)) {
					return
				}
			...
			case 27:
				...
				unhighlight()
				$g[63].setTxt("list now in ascending order")
			...
			case 44:
				$g[54][$stack[$fp-3]].translate((SZ+GAP)*($stack[$fp-4]-$stack[$fp-3]), 0, TICKS, 0)
				$pc = 45
				if ($g[54][$stack[$fp-4]].translate(-(SZ+GAP)*($stack[$fp-4]-$stack[$fp-3]), 0, TICKS, 1)) {
					return
				}
			case 45:
				$g[54][$stack[$fp-3]].translate(0, 100, TICKS, 0)
			...
			case 48:
				$g[59]++
				$g[60].setTxt("comparisons: %d", $g[59])
				$return(2)
				continue
			case 49:
				$enter(1);	// exchange
				...
				$call(43, $obj, $stack[$fp-3], $stack[$fp-4])
				continue
			case 50:
				$g[61]++
				$g[62].setTxt("exchanges: %d", $g[61])
				$return(2)
				continue
			case 51:
				$enter(4);	// classicShellSort
				$stack[$fp+1]=N
				$pc = 52
			case 52:
				$stack[$fp+1]=(($stack[$fp+1]+2)/3)|0
				$g[63].setTxt("BubbleBack sort elements %d items apart", $stack[$fp+1])
				$g[58].setPos($g[56]+SZ/2, Y+SZ)
				$stack[$fp+2]=0
				$pc = 53
			case 53:
				...
				$pc = 54
				if ($g[58].setPos($g[56]+SZ/2+$stack[$fp+2]*(SZ+GAP), Y+SZ, TICKS, 1)) {
					return
				}
			case 54:
				$call(38, $obj, $stack[$fp+2], $stack[$fp+1])
				continue
			case 55:
				$stack[$fp+3]=$stack[$fp+2]+$stack[$fp+1]
				$pc = 56
			case 56:
				if (!($stack[$fp+3]<N)) {
					$pc = 65
				...
				$pc = 57
			case 57:
				if (!($stack[$fp+4]>$stack[$fp+2])) {
					$pc = 63
					continue
				}
				$call(47, $obj, $stack[$fp+4]-$stack[$fp+1], $stack[$fp+4])
				continue
			case 58:
				if (!($g[53][$stack[$fp+4]-$stack[$fp+1]]>$g[53][$stack[$fp+4]])) {
					$pc = 60
					continue
				}
				$call(49, $obj, $stack[$fp+4]-$stack[$fp+1], $stack[$fp+4])
				continue
			case 59:
				$pc = 61
				continue
			...
			case 70:
				$stack[$fp+1]=(($stack[$fp+1]+2)/3)|0
				$g[63].setTxt("Bubble sort elements %d items apart", $stack[$fp+1])
				$g[58].setPos($g[56]+SZ/2, Y+SZ)
			...
			case 71:
				...
				$call(38, $obj, $stack[$fp+2]-$stack[$fp+1], $stack[$fp+1])
				continue
			case 72:
				$stack[$fp+3]=$stack[$fp+2]
				$pc = 73
			case 73:
				if (!($stack[$fp+3]>=$stack[$fp+1])) {
					$pc = 79
					continue
				}
				$call(47, $obj, $stack[$fp+3]-$stack[$fp+1], $stack[$fp+3])
				continue
			case 74:
				if (!($g[53][$stack[$fp+3]-$stack[$fp+1]]>$g[53][$stack[$fp+3]])) {
					$pc = 76
					continue
				}
				$call(49, $obj, $stack[$fp+3]-$stack[$fp+1], $stack[$fp+3])
				continue
			case 75:
				$pc = 77
				continue
