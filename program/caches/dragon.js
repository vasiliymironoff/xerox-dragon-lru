// generated by VivioJS 22.02 build 0 : 3-May-24 22:36:03
...
function dragon(vplayer) {
	...
	function Memory(_x, _y) {
		...
		for (this.$i=0; this.$i<NADDR; this.$i++) {
			this.$mem[this.$i]=0
			this.$stale[this.$i]=0
			this.$memR[this.$i]=new Rectangle2($g[0], 0, 0, $g[1], this.$i%2==0 ? $g[17] : $g[30], this.$x+this.$bgap, this.$y+(this.$i+1)*this.$bgap+this.$i*this.$bh, this.$bw, this.$bh, $g[1], $g[36], "address: a%d data: %d", this.$i, this.$mem[this.$i])
	...
	Memory.prototype.$highlight = function(addr, flag) {
		this.$memR[addr].setBrush((flag) ? $g[19] : (this.$stale[addr]) ? $g[29] : addr%2==0 ? $g[17] : $g[30])
	}
	...
	function showBusOp(s) {
		$g[52].setTxt(s)
		let w=$g[52].getTxtW()+16
		$g[52].setPt(0, -w/2, -10)
		$g[52].setPt(1, w/2, 10)
		$g[52].setOpacity(1, TICKS, 0)
	}
	...
	function Cache(x, y, _cpuN) {
		...
		for (this.$i=0; this.$i<NSET; this.$i++) {
			this.$state[this.$i]=I
			this.$stateR[this.$i]=new Rectangle2($g[0], 0, 0, $g[1], this.$i%2==0 ? $g[17] : $g[30], x+this.$bgap, y+(this.$i+1)*this.$bgap+this.$i*this.$bh, this.$bw0, this.$bh, $g[1], $g[36])
			this.$stateR[this.$i].setRounded(2, 2)
			this.$a[this.$i]=-1
			this.$aR[this.$i]=new Rectangle2($g[0], 0, 0, $g[1], this.$i%2==0 ? $g[17] : $g[30], x+2*this.$bgap+this.$bw0, y+(this.$i+1)*this.$bgap+this.$i*this.$bh, this.$bw1, this.$bh, $g[1], $g[36])
			this.$aR[this.$i].setRounded(2, 2)
			this.$d[this.$i]=0
			this.$dR[this.$i]=new Rectangle2($g[0], 0, 0, $g[1], this.$i%2==0 ? $g[17] : $g[30], x+3*this.$bgap+this.$bw0+this.$bw1, y+(this.$i+1)*this.$bgap+this.$i*this.$bh, this.$bw1, this.$bh, $g[1], $g[36])
			this.$dR[this.$i].setRounded(2, 2)
		}
		for (this.$i=0; this.$i<NADDR; this.$i++) {
			this.$time_lru[this.$i]=-1
			this.$wValue[this.$i]=0
		}
	}
	...
	Cache.prototype.$setValues = function(set, addr, data) {
		this.$a[set]=addr
		this.$aR[set].setTxt("%d%d%d", (addr>>3)%2, (addr>>2)%2, (addr>>1)%2)
		this.$d[set]=data
		this.$dR[set].setTxt("%d", data)
	}

	Cache.prototype.$highlight = function(set, flag) {
		let brush=flag ? $g[19] : set%2==0 ? $g[17] : $g[30]
	...
	Cache.prototype.$resetBus = function() {
		...
		for (let i=0; i<NCPU; i++) {
			$g[54][i].$abus.$reset()
			$g[54][i].$dbus.$reset()
			$g[54][i].$sharedbus.$reset()
		}
		$g[52].setOpacity(0, TICKS, 0)
	}

	Cache.prototype.$update_lru = function(set) {
		this.$time_lru[set]=$g[56]
		$g[56]++
	}
	...
	function CPU(x, y, _cpuN) {
		...
		for (this.$i=0; this.$i<NADDR; this.$i++) {
			...
			this.$rb[this.$i].setBrush(this.$i%2==0 ? $g[17] : $g[30])
			this.$wb[this.$i].setBrush(this.$i%2==0 ? $g[17] : $g[30])
		}
	}
	...
	CPU.prototype.$CPUButton = function($parent, $grp, _rw, x, y, _addr) {
		...
		this.addEventHandler("eventMB", this, 110)
	}
	...
	function $execute(thread) {
		...
		while (1) {
			...
			case 0:
				...
				$g[50]=new Bus(30, SBUSY, SBUSW, W-40, GRAY32)
				new Txt($g[0], 0, HLEFT|VTOP, 220, SBUSY-25, $g[7], $g[39], "shared")
				$g[51]=new Memory((W-MEMW)/2, MEMY)
				$g[52]=new Rectangle($g[0], 0, 0, $g[1], $g[17], W/2, BUSOPY, 0, 0, 0, 0, 0, $g[38])
				$g[52].setOpacity(0)
				$g[52].setRounded(4, 4)
				$g[53]=new Txt($g[0], 0, HLEFT, 2*W/3+30, (ABUSY+DBUSY)/2, 0, $g[39], "bus cycles: %d", $g[47])
				$g[54]=newArray(NCPU)
				$g[55]=newArray(NCPU)
				$g[56]=0
				$g[54][0]=new Cache((W-5*CACHEW)/2, CACHEY, 0)
				$g[54][1]=new Cache((W-5*CACHEW)/2+1.3*CACHEW, CACHEY, 1)
				$g[54][2]=new Cache((W-5*CACHEW)/2+2.7000000000000002*CACHEW, CACHEY, 2)
				$g[54][3]=new Cache((W-5*CACHEW)/2+4*CACHEW, CACHEY, 3)
				$g[55][0]=new CPU((W-5*CPUW)/2, CPUY, 0)
				$g[55][1]=new CPU((W-5*CPUW)/2+1.3*CPUW, CPUY, 1)
				$g[55][2]=new CPU((W-5*CPUW)/2+2.7000000000000002*CPUW, CPUY, 2)
				$g[55][3]=new CPU((W-5*CPUW)/2+4*CPUW, CPUY, 3)
				$g[57]=new SimpleButton($g[0], W-2*BW-2*BW/8, BY, BW, BH, $g[17], $g[30], $g[32], $g[12], $g[1], $g[36], $g[37], "reset")
				$g[57].addEventHandler("eventMB", $obj, 126)
				$return(0)
				continue
			case 1:
				$enter(0);	// moveUp
			...
			case 5:
				$enter(4);	// flush
				$stack[$fp+1]=-1
				$stack[$fp+2]=$stack[$fp-4]%ASS
				$stack[$fp+3]=$stack[$fp+2]+2
				if (!($obj.$a[$stack[$fp+2]]==$stack[$fp-4])) {
					$pc = 6
					continue
				}
				...
				continue
			case 6:
				if (!($obj.$a[$stack[$fp+3]]==$stack[$fp-4])) {
					$pc = 7
					continue
				}
			...
			case 7:
				$pc = 8
			case 8:
				$stack[$fp+4]=$obj.$a[$stack[$fp+1]]
				if (!($stack[$fp-4]==$stack[$fp+4])) {
					$pc = 13
					continue
				}
			...
			case 10:
				$g[49].$setColour(BLUE)
				$g[48].$setColour(RED)
				$call(1, $g[51].$abus, TICKS, 0)
				continue
			case 11:
				$call(1, $g[51].$dbus, TICKS, 1)
				continue
			case 12:
				showBusOp(sprintf("CPU %d writes a%d in memory", $stack[$fp-3], $stack[$fp-4]))
				$g[51].$stale[$stack[$fp+4]]=0
				$g[51].$memR[$stack[$fp+4]].setBrush($g[17])
				$g[51].$mem[$stack[$fp+4]]=$obj.$d[$stack[$fp+1]]
				$g[51].$memR[$stack[$fp+4]].setTxt("address: a%d data: %d", $stack[$fp+4], $g[51].$mem[$stack[$fp+4]])
				$obj.$resetBus()
				$pc = 13
			case 13:
				$return(2)
				continue
			case 14:
				$enter(10);	// busWatchHelper
				if (!($stack[$fp-6]>-1)) {
					$pc = 26
					continue
				}
				$stack[$fp+1]=-1
				$stack[$fp+2]=$stack[$fp-6]%ASS
				$stack[$fp+3]=$stack[$fp+2]+2
				if (!($obj.$a[$stack[$fp+2]]==$stack[$fp-6])) {
					$pc = 15
					continue
				}
				$stack[$fp+1]=$stack[$fp+2]
				...
				continue
			case 15:
				if (!($obj.$a[$stack[$fp+3]]==$stack[$fp-6])) {
					$pc = 16
					continue
				}
				$stack[$fp+1]=$stack[$fp+3]
			...
			case 18:
				...
				if (!($stack[$fp+6]!=$obj.$cpuN&&($g[54][$stack[$fp+6]].$a[$stack[$fp+2]]==$stack[$fp-6]||$g[54][$stack[$fp+6]].$a[$stack[$fp+3]]==$stack[$fp-6]))) {
					$pc = 19
					continue
				}
				$stack[$fp+5]++
			...
			case 21:
				...
				if (!($obj.$state[$stack[$fp+1]]==SC)) {
					$pc = 22
					continue
				}
				$obj.$state[$stack[$fp+1]]=VE
				$obj.$stateR[$stack[$fp+1]].setTxt("VE")
				$pc = 22
			case 22:
			...
			case 26:
				$stack[$fp+7]=-1
				$stack[$fp+8]=$stack[$fp-3]%ASS
				$stack[$fp+9]=$stack[$fp+8]+2
				if (!($obj.$a[$stack[$fp+8]]==$stack[$fp-3])) {
					$pc = 27
					continue
				}
				$stack[$fp+7]=$stack[$fp+8]
				$pc = 29
				continue
			case 27:
				if (!($obj.$a[$stack[$fp+9]]==$stack[$fp-3])) {
					$pc = 28
					continue
				}
				$stack[$fp+7]=$stack[$fp+9]
				$pc = 28
			case 28:
				$pc = 29
			case 29:
				$stack[$fp+10]=(($stack[$fp+7]>=0)|0)
				if (!(((!$stack[$fp+10])|0))) {
					$pc = 31
					continue
				}
			...
			case 30:
				$pc = 31
			case 31:
				if (!($stack[$fp+10]&&$stack[$fp-4]==0&&$obj.$state[$stack[$fp+7]]!=SC)) {
					$pc = 37
					continue
				}
				$call(3, $obj.$abus, TICKS, 1)
				continue
			case 32:
				if (!($obj.$state[$stack[$fp+7]]==D)) {
					$pc = 33
					continue
				}
				$obj.$state[$stack[$fp+7]]=SD
				$obj.$stateR[$stack[$fp+7]].setTxt("SD")
				$pc = 33
			case 33:
				if (!($obj.$state[$stack[$fp+7]]==VE)) {
					$pc = 34
					continue
				}
				$obj.$state[$stack[$fp+7]]=SC
				$obj.$stateR[$stack[$fp+7]].setTxt("SC")
				$pc = 34
			case 34:
				$g[45]=1
				$g[43]=$obj.$cpuN
			...
			case 36:
				$g[48].$setColour(RED)
				$g[50].$setColour(MAGENTA)
				$return(4)
				continue
			case 37:
				if (!($stack[$fp+10]&&$stack[$fp-4]==1)) {
					$pc = 42
					continue
				}
				if (!($obj.$state[$stack[$fp+7]]==SD)) {
					$pc = 38
					continue
				}
				$obj.$state[$stack[$fp+7]]=SC
			...
			case 40:
				...
				continue
			case 41:
				$obj.$setValues($stack[$fp+7], $stack[$fp-3], $stack[$fp-5])
				$pc = 42
			case 42:
				$return(4)
				continue
			...
			case 44:
				...
				fork(14, $g[54][$stack[$fp+1]], $stack[$fp-3], $stack[$fp-5], $stack[$fp-6], $stack[$fp-7])
				$pc = 45
			case 45:
				$pc = 46
			case 46:
			...
			case 48:
				...
				$call(3, $g[54][$stack[$fp-4]].$sharedbus, TICKS, 0)
				continue
			case 49:
				$pc = 50
			case 50:
			...
			case 61:
				$stack[$fp+1]=-1
				$stack[$fp+2]=-1
				$stack[$fp+3]=$stack[$fp-3]%ASS
				$stack[$fp+4]=$stack[$fp+3]+2
				...
				continue
			case 62:
				if (!($obj.$a[$stack[$fp+4]]==$stack[$fp-3])) {
					$pc = 63
					continue
				}
				$stack[$fp+2]=$stack[$fp+4]
				$pc = 63
			case 63:
				$pc = 64
			case 64:
				...
				$obj.$highlight($stack[$fp+2], 1)
				$obj.$update_lru($stack[$fp+2])
				if (!($stack[$fp-4])) {
					$pc = 66
					continue
				}
			...
			case 66:
				...
				continue
			case 67:
				if (!($obj.$time_lru[$stack[$fp+3]]>$obj.$time_lru[$stack[$fp+4]])) {
					$pc = 68
					continue
				}
				$stack[$fp+1]=$obj.$a[$stack[$fp+4]]
				$stack[$fp+2]=$stack[$fp+4]
				$pc = 69
				continue
			case 68:
				$stack[$fp+1]=$obj.$a[$stack[$fp+3]]
				$stack[$fp+2]=$stack[$fp+3]
				$pc = 69
			case 69:
				if (!($obj.$a[$stack[$fp+2]]!=-1&&($obj.$state[$stack[$fp+2]]==D||$obj.$state[$stack[$fp+2]]==SD))) {
					$pc = 71
					continue
				}
				$stack[$fp+5]=$obj.$a[$stack[$fp+2]]
				$call(5, $obj, $obj.$cpuN, $stack[$fp+5])
				continue
			case 70:
				$pc = 71
			case 71:
			...
			case 72:
				$obj.$resetBus()
				$g[47]++
				$g[53].setTxt("bus cycles: %d", $g[47])
				$obj.$highlight($stack[$fp+2], 1)
				$call(1, $obj.$abus, TICKS, 1)
				continue
			case 73:
				$g[49].$setColour(BLUE)
				fork(43, $obj, $stack[$fp-3], $obj.$cpuN, 0, -1, $stack[$fp+1])
				$call(1, $g[51].$abus, TICKS, 1)
				continue
			case 74:
				if (!($g[45])) {
					$pc = 77
			...
			case 75:
				...
				continue
			case 76:
				$obj.$setValues($stack[$fp+2], $stack[$fp-3], $g[54][$g[43]].$d[$g[44]])
				$obj.$state[$stack[$fp+2]]=SC
				$obj.$stateR[$stack[$fp+2]].setTxt("SC")
				$pc = 80
				continue
			case 77:
				showBusOp(sprintf("CPU %d reads a%d from memory", $obj.$cpuN, $stack[$fp-3]))
				$g[51].$highlight($stack[$fp-3], 1)
				$call(3, $g[51].$dbus, TICKS, 1)
				continue
			case 78:
				$g[48].$setColour(RED)
				$call(3, $obj.$dbus, TICKS, 1)
				continue
			case 79:
				$obj.$setValues($stack[$fp+2], $stack[$fp-3], $g[51].$mem[$stack[$fp-3]])
				$obj.$state[$stack[$fp+2]]=VE
				$obj.$stateR[$stack[$fp+2]].setTxt("VE")
				$pc = 80
			case 80:
				$obj.$update_lru($stack[$fp+2])
				$call(57, $obj)
			...
			case 95:
				...
				$obj.$setValues($stack[$fp+1], $stack[$fp-3], $obj.$wValue[$stack[$fp-3]])
				$pc = 96
			case 96:
			...
			case 101:
				...
				$g[48].$setColour(RED)
				$g[50].$setColour(MAGENTA)
				fork(43, $obj, $stack[$fp-3], $obj.$cpuN, 1, $obj.$wValue[$stack[$fp-3]], -1)
				$call(57, $obj)
				continue
			case 102:
				$pc = 103
			...
			case 104:
				...
				$g[54][$obj.parent.$cpuN].$resetBus()
				$pc = 105
			case 105:
				$obj.parent.$buttonLock=1
				$g[54][$obj.parent.$cpuN].$reset()
				...
				$call(84, $g[54][$obj.parent.$cpuN], $obj.$addr)
				continue
			case 106:
				$pc = 109
				continue
			case 107:
				$call(59, $g[54][$obj.parent.$cpuN], $obj.$addr, 1)
				continue
			case 108:
				$pc = 109
			case 109:
