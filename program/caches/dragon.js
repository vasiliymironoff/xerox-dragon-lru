// generated by VivioJS 22.02 build 0 : 15-Apr-24 14:29:15
...
function dragon(vplayer) {
	...
	CPU.prototype.$CPUButton = function($parent, $grp, _rw, x, y, _addr) {
		...
		this.addEventHandler("eventMB", this, 88)
	}
	...
	function $execute(thread) {
		...
		while (1) {
			...
			case 0:
				...
				$g[56]=new SimpleButton($g[0], W-2*BW-2*BW/8, BY, BW, BH, $g[17], $g[30], $g[32], $g[12], $g[1], $g[36], $g[37], "reset")
				$g[56].addEventHandler("eventMB", $obj, 104)
				$return(0)
				continue
			case 1:
				$enter(0);	// moveUp
			...
			case 10:
				...
				$g[51].$stale[$stack[$fp+3]]=0
				$g[51].$memR[$stack[$fp+3]].setBrush($g[17])
				$g[51].$mem[$stack[$fp+3]]=$obj.$d[$stack[$fp+2]]
				$g[51].$memR[$stack[$fp+3]].setTxt("address: a%d data: %d", $stack[$fp+3], $g[51].$mem[$stack[$fp+3]])
				$obj.$resetBus()
				$pc = 11
			case 11:
				$pc = 12
			...
			case 18:
				...
				$g[54][$obj.$cpuN].$highlight($stack[$fp+1], 1)
				$call(1, $g[54][$obj.$cpuN].$dbus, TICKS, 0)
				continue
			case 19:
			...
			case 26:
				...
				fork(14, $g[54][$stack[$fp+1]], $stack[$fp-3], $stack[$fp-5])
				$pc = 27
			case 27:
				$pc = 28
			case 28:
			...
			case 51:
				...
				continue
			case 52:
				fork(25, $obj, $stack[$fp-3], $obj.$cpuN, 0)
				$pc = 53
				if (wait(TICKS)) {
					return
				}
			...
			case 54:
				showBusOp(sprintf("CPU %d reads a%d from memory - CPU %d intervenes and supplies data from its cache", $obj.$cpuN, $stack[$fp-3], $g[44]))
				$g[48].$setColour(RED)
				$call(1, $g[51].$dbus, TICKS, 0)
				continue
			case 55:
				$call(3, $obj.$dbus, TICKS, 1)
				continue
			case 56:
				$g[51].$mem[$stack[$fp-3]]=$g[54][$g[44]].$d[$stack[$fp+1]]
				$g[51].$stale[$stack[$fp-3]]=0
				$g[51].$memR[$stack[$fp-3]].setBrush($g[17])
				$g[51].$memR[$stack[$fp-3]].setTxt("address: a%d data: %d", $stack[$fp-3], $g[51].$mem[$stack[$fp-3]])
			...
			case 60:
				...
				$obj.$d[$stack[$fp+1]]=$g[51].$mem[$stack[$fp-3]]
				$obj.$dR[$stack[$fp+1]].setTxt("%d", $obj.$d[$stack[$fp+1]])
				$obj.$state[$stack[$fp+1]]=$g[45] ? SHARED : EXCLUSIVE
				$obj.$stateR[$stack[$fp+1]].setTxt($g[45] ? "S" : "E")
				$call(38, $obj)
				continue
			case 61:
				if (!($stack[$fp-4])) {
			...
			case 66:
				...
				$g[51].$stale[$stack[$fp-3]]=1
				$g[51].$memR[$stack[$fp-3]].setBrush($g[29])
				$return(1)
				continue
			case 67:
				$pc = 68
			...
			case 75:
				...
				continue
			case 76:
				fork(25, $obj, $stack[$fp-3], $obj.$cpuN, 1)
				$obj.$state[$stack[$fp+1]]=EXCLUSIVE
				$obj.$stateR[$stack[$fp+1]].setTxt("E")
				$g[51].$mem[$stack[$fp-3]]=$obj.$d[$stack[$fp+1]]
				$g[51].$memR[$stack[$fp-3]].setTxt("address: a%d data: %d", $stack[$fp-3], $g[51].$mem[$stack[$fp-3]])
				$g[51].$highlight($stack[$fp-3], 1)
				$call(38, $obj)
				continue
			...
			case 83:
				...
				$call(64, $g[54][$obj.parent.$cpuN], $obj.$addr)
				continue
			case 84:
				$pc = 87
				continue
			case 85:
				$call(40, $g[54][$obj.parent.$cpuN], $obj.$addr, 1)
				continue
			case 86:
				$pc = 87
			case 87:
