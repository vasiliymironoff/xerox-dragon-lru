// generated by VivioJS 22.02 build 0 : 10-Apr-24 10:38:45
...
function dragon(vplayer) {
	...
	CPU.prototype.$CPUButton = function($parent, $grp, _rw, x, y, _addr) {
		...
		this.addEventHandler("eventMB", this, 91)
	}
	...
	function $execute(thread) {
		...
		while (1) {
			...
			case 18:
				$g[50].$setColour(BLUE)
				$g[49].$setColour(RED)
				$call(12, $g[52].$abus, TICKS, 0)
				continue
			case 19:
				$call(12, $g[52].$dbus, TICKS, 1)
				continue
			case 20:
			...
			case 25:
				...
				$call(12, $g[55][$obj.$cpuN].$dbus, TICKS, 0)
				continue
			case 26:
				$pc = 27
			case 27:
			...
			case 33:
				...
				fork(21, $g[55][$stack[$fp+1]], $stack[$fp-3], $stack[$fp-5])
				$pc = 34
			case 34:
				$pc = 35
			case 35:
			...
			case 37:
				$call(14, $g[55][$stack[$fp-4]].$sharedbus, TICKS, 0)
				continue
			case 38:
				$pc = 39
			case 39:
			...
			case 54:
				...
				continue
			case 55:
				fork(32, $obj, $stack[$fp-3], $obj.$cpuN, 0)
				$pc = 56
				if (wait(TICKS)) {
					return
				}
			...
			case 78:
				...
				continue
			case 79:
				fork(32, $obj, $stack[$fp-3], $obj.$cpuN, 1)
			...
			case 86:
				...
				$call(67, $g[55][$obj.parent.$cpuN], $obj.$addr)
				continue
			case 87:
				$pc = 90
				continue
			case 88:
				$call(47, $g[55][$obj.parent.$cpuN], $obj.$addr, 1)
				continue
			case 89:
				$pc = 90
			case 90:
