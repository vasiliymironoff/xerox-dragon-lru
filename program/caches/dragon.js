// generated by VivioJS 22.02 build 0 : 17-Apr-24 13:43:26
	...
	function $execute(thread) {
		...
		while (1) {
			...
			case 0:
				...
				$g[58].addEventHandler("eventMB", $obj, 113)
				$return(0)
				continue
			case 1:
				$enter(0);	// moveUp
			...
			case 12:
				...
				$g[52].$stale[$stack[$fp+4]]=0
				$g[52].$memR[$stack[$fp+4]].setBrush($g[17])
				$g[52].$mem[$stack[$fp+4]]=$obj.$d[$stack[$fp+1]]
				$g[52].$memR[$stack[$fp+4]].setTxt("address: a%d data: %d", $stack[$fp+4], $g[52].$mem[$stack[$fp+4]])
				$obj.$resetBus()
				$pc = 13
			case 13:
				$return(2)
			...
			case 54:
				...
				$pc = 55
			case 55:
				if (!($obj.$a[$stack[$fp+1]]!=-1&&($obj.$state[$stack[$fp+1]]==D||$obj.$state[$stack[$fp+1]]==SD))) {
					$pc = 58
					continue
				}
				if (!($obj.$state[$stack[$fp+1]])) {
					$pc = 56
					continue
				}
				$pc = 56
			case 56:
				$stack[$fp+4]=$obj.$a[$stack[$fp+1]]
				$call(5, $obj, $obj.$cpuN, $stack[$fp+4])
				continue
			case 57:
				$pc = 58
			case 58:
			...
			case 60:
				$g[50].$setColour(BLUE)
				fork(29, $obj, $stack[$fp-3], $obj.$cpuN, 0)
			...
			case 88:
				...
				$g[49].$setColour(RED)
				$g[51].$setColour(MAGENTA)
				fork(29, $obj, $stack[$fp-3], $obj.$cpuN, 1)
				$call(43, $obj)
				continue
			case 89:
				$pc = 90
			...
			case 92:
				...
				$call(71, $g[55][$obj.parent.$cpuN], $obj.$addr)
				continue
			case 93:
				$pc = 96
				continue
			case 94:
				$call(45, $g[55][$obj.parent.$cpuN], $obj.$addr, 1)
				continue
			case 95:
				$pc = 96
			case 96:
